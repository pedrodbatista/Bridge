...
SELECT 
CASE
    WHEN A.DIA_DA_SEMANA = 0 THEN 'Domingo'
    WHEN A.DIA_DA_SEMANA = 1 THEN 'Segunda'
    WHEN A.DIA_DA_SEMANA = 2 THEN 'Terca'
    WHEN A.DIA_DA_SEMANA = 3 THEN 'Quarta'
    WHEN A.DIA_DA_SEMANA = 4 THEN 'Quinta'
    WHEN A.DIA_DA_SEMANA = 5 THEN 'Sexta'
    WHEN A.DIA_DA_SEMANA = 6 THEN 'Sabado'
END as DAY_NAME,
