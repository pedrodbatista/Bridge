...
CREATE TABLE UNIDADE (
    ...
    RUA VARCHAR(50) NOT NULL,
    NUMERO INTEGER NOT NULL,
    TEL1 VARCHAR(15) NOT NULL, -- Inserir so os numeros!
...
CREATE TABLE LABORATORIO (
    ...
    CONSTRAINT FK_SALA_LABORATORIO FOREIGN KEY(UNIDADE, ANDAR, NUMERO) 
...
CREATE TABLE SALA_DE_AULA (
    ...
    CONSTRAINT FK_SALA_SALA_DE_AULA FOREIGN KEY(UNIDADE, ANDAR, NUMERO) 
        REFERENCES SALA(UNIDADE, ANDAR, NUMERO)
        ON DELETE CASCADE
...
CREATE TABLE SOLICITACAO_DOACAO (
    ...
    EQUIPAMENTO VARCHAR(30) DEFAULT NULL,    -- Eh NULL enquanto a solicitacao nao eh satisfeita
    DATA_HORA_DOACAO TIMESTAMP DEFAULT NULL, -- Eh NULL enquanto a solicitacao nao eh satisfeita
